...
public class TttTestContainer extends TestContainer {

    public TttTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/ttt/app.properties",
    ...
    public static class Common extends TttTestContainer {

        public static final TttTestContainer.Common INSTANCE = new TttTestContainer.Common();
